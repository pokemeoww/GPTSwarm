...
def calculate_combo_hash(input_data: Any, output_data: Any=None) -> str:
    """计算input+output的组合哈希值"""
    combo = {
        "input": input_data,
    }
    if output_data:
        combo["output"] = output_data
        ...
        try:
            with open(file_path, 'r', encoding='utf-8') as f:
                for line_num, line in enumerate(f, 1):
                    ...
                    combo_hash = calculate_combo_hash(exp["input"])
...
def main():
    list_experience_files = [
            "/root/sijia/GPTSwarm/data/experiences/2026-01-05_09-22-45_train_1/code_writing_demos.jsonl",
            "/root/sijia/GPTSwarm/data/experiences/2026-01-05_09-28-24_train_2/code_writing_demos.jsonl",
        ]

    output_path = "data/experiences/demos_jan_5_human_eval_train_2/list_demos_code_writing.json"
    # 处理文件
